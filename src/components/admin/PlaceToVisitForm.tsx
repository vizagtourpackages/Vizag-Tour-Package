...
import { savePlace } from '@/app/admin/places-to-visit/actions'
import ImageUpload from './ImageUpload'
import Link from 'next/link'

export default function PlaceToVisitForm({ initialData, id }: { initialData?: any, id: string }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-8 max-w-4xl bg-white p-8 rounded-xl shadow-sm border border-gray-100">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4 md:col-span-2">
          <h3 className="text-lg font-bold border-b pb-2">Place Details</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Category (e.g. Beach, Museum)</label>
        ...
        <div className="md:col-span-2 pt-4 border-t flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <Link href="/admin/places-to-visit" className="px-6 py-2.5 border rounded-lg font-medium hover:bg-gray-50">
              Cancel
            </Link>
